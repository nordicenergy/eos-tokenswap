...
div
  el-tabs(type='border-card').mt-4
    ...
    el-tab-pane(label='Rules & Information')
      h2.lead.ml-3.mt-3 With TOKENSWAP you can exchange Nordic Energy tokens, EOS.IO tokens, for any other EOS.IO tokens,
      ...
      h4.ml-3 Audit:
        ul.mt-1
          li.lead Exchange contract:
            a(:href="'wwwswapnordicenergyio/eosio' | monitorAccount" target="_blank") wwwswapnordicenergyio/eosio
    ...
    el-tab-pane(label='Partners').p-3
      ...
      hr
      .d-flex
        a(href="https://tokenswap.nordicenergy.io/eos/nameswaps/" target="_blank").btn
          .d-flex.align-items-center.span
            img(src="https://www.eosnameswaps.com/images/ens_logo.jpg" height="80").mr-3
            .lead A decentralized Nordic Energy´s EOS account exchange.
